...
const Updated = () => {
  ...
  const scrollToListItem = (letter) => {
    ...
    sectionListRef.current.scrollToLocation({
      sectionIndex: index,
      itemIndex: 0,
      viewOffset: 30, // added for some spacing between section header and alphabet list
      viewPosition: 0.5, // added to center the section header in the screen
    });
  };
...
const styles = StyleSheet.create({
  ...
  alphabetList: {
    flexDirection: "column", // changed to column for vertical orientation
