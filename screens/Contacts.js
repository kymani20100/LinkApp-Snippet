...
//   const [keyboardShown, setKeyboardShown] = useState(false);
  ...
  return (
    ...
    <Box safeAreaTop zIndex={200} bg="#0085f7" />
    {selectedItems.length > 0 ? 
      (
      <HStack bg="#0085f7" px="3" mt={-2} zIndex={200} justifyContent="space-between" alignItems="center" w="100%" maxW="350">
    ...
    <HStack bg="#0085f7" px="3" mt={-2} zIndex={200} justifyContent="space-between" alignItems="center" w="100%" maxW="350">
      ...
      <HStack bg="#0085f7" px="3" mt={-2} zIndex={200} py="2" w="100%" maxW="350">
            <Searchbar
                elevation={0}
                inputStyle={{color: '#0085f7'}}
                iconColor={'#0085f7'}
                style={{height: 35, width: '100%', borderRadius: 5, backgroundColor: '#FFF'}}
                placeholder="Search..."
        ...
        <SectionList
            ...
            renderItem={({ item }) => (
              ...
              //   >
                ...
                // </View>
              // </TouchableOpacity>
              <LongPress onShortPress={() => {longPress === true ? handleItemPress(item.id) : handlePhoneIconPress(item.phone)}} onLongPress={() => handleItemPress(item.id)} longPressDuration={100} style={{ backgroundColor: 'white' }}>
                      <View style={styles.contactItem}>
                        <Text style={styles.contactList}>{item.name}</Text>
                      </View>
              </LongPress>
