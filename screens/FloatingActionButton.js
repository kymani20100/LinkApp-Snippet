...
import { 
 ...
 const colors = [
    ...nicecolors[3].slice(1, nicecolors[1].length),...nicecolors[55].slice(0,3),
];
...
import {ScrollView, Spacer, Center, Heading, HStack, VStack, Icon, Box, IconButton, FlatList} from "native-base";
    ...
    return (
      ...
      <View>
            <FlatList 
              data={data} 
              numColumns={2} 
              renderItem={({item, index}) => <ViewCard props={item} color={colors[index % colors.length]} />} 
